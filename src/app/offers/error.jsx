...
import { FaExclamationTriangle, FaHome, FaRedo, FaTags } from "react-icons/fa";
  ...
  return (
    <div className="bg-[#f6f6f6] flex flex-col items-center justify-center px-4 py-10 ">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center relative z-50">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-4">خطا در نمایش پیشنهادات</h1>
        <p className="text-gray-600 mb-6">
          متأسفانه مشکلی در نمایش پیشنهادات رخ داده است. لطفاً دوباره تلاش کنید.
        </p>
