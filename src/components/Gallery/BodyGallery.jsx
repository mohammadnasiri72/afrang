              ...
              <>
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <span className="text-xl font-semibold pr-1">{likedNumber}</span>
                      </>
                    )}
                  </div>
                </div>
                ...
                <div className="flex flex-wrap sm:flex-nowrap items-center mt-5 gap-7">
                  ...
                  <div className="flex items-center gap-2 sm:w-auto w-full">
                    ...
                    <span className="font-semibold text-[16px]"> {imgSelected?.senderTitle || 'نامشخص'}</span>
                  </div>
                  <div className="flex items-center gap-2 sm:w-auto w-full">
                    <LuCalendarRange className="text-[#444]" />
                    <span className="text-[#444]">زمان عکاسی :</span>
                    <span className="font-semibold text-[16px]">
                      {propertySelected.find(item => item.propertyKey === 'gal_time')?.value || 'نامشخص'}
                    </span>
                  </div>
                </div>
                <div className="mt-10 flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-[#312e42] text-[14px]">نوع دوربین :</span>
                    <span className="font-bold">
                      {propertySelected.find(item => item.propertyKey === 'gal_camera')?.value || 'نامشخص'}
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-[#312e42] text-[14px]">نوع لنز :</span>
                    <span className="font-bold">
                      {propertySelected.find(item => item.propertyKey === 'gal_lenz')?.value || 'نامشخص'}
                    </span>
                  </div>
                </div>
            ...
            ImagesData?.map((item) => (
              ...
              >
                <div
                  ...
                  className={`bg-white rounded-sm border-4 shadow-lg cursor-pointer ${imgSelected?.id === item.id
                    ? "border-[#d1182b]"
                    : "border-white"
                    }`}
                >
