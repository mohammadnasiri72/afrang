          ...
          <div className="mt-[-160px] !mb-[10px]">
            <div className="flex flex-wrap">
              <div className="md:w-1/4 w-1/2 p-2">
                <div className="rounded-lg w-full  relative overflow-hidden ">
                  <Link
                    href={mainBanner[0]?.link || "#"}
                    onClick={(ev) => {
                      ev.preventDefault();
                      startTransition(() => {
                        router.push(mainBanner[0]?.link);
                      });
                    }}
                  >
                    <img
              ...
              <div className="w-full sm:w-1/2 md:w-1/2 hidden md:block p-2">
                <div className="rounded-lg w-full relative overflow-hidden">
                  <Link
                    href={mainBanner[1]?.link || "#"}
                    onClick={(ev) => {
                      ev.preventDefault();
                      startTransition(() => {
                        router.push(mainBanner[1]?.link);
                      });
                    }}
                  >
                    <img
              ...
              <div className="md:w-1/4 w-1/2 p-2">
                <div className="rounded-lg w-full relative overflow-hidden">
                  <Link
                    href={mainBanner[2]?.link || "#"}
                    onClick={(ev) => {
                      ev.preventDefault();
                      startTransition(() => {
                        router.push(mainBanner[2]?.link);
                      });
                    }}
                  >
                    <img
            ...
            <div className="flex flex-wrap">
              <div className="sm:w-1/4 md:w-1/4 w-1/2 p-2">
                <div className="rounded-lg relative overflow-hidden">
                  <Link
                    href={mainBanner[3]?.link || "#"}
                    onClick={(ev) => {
                      ev.preventDefault();
                      startTransition(() => {
                        router.push(mainBanner[3]?.link);
                      });
                    }}
                  >
                    <img
              ...
              <div className="sm:w-1/4 md:w-1/4 w-1/2 p-2">
                <div className="rounded-lg relative overflow-hidden">
                  <Link
                    href={mainBanner[4]?.link || "#"}
                    onClick={(ev) => {
                      ev.preventDefault();
                      startTransition(() => {
                        router.push(mainBanner[4]?.link);
                      });
                    }}
                  >
                    <img
              ...
              <div className="sm:w-1/4 md:w-1/4 w-1/2 p-2">
                <div className="rounded-lg relative overflow-hidden">
                  <Link
                    href={mainBanner[5]?.link || "#"}
                    onClick={(ev) => {
                      ev.preventDefault();
                      startTransition(() => {
                        router.push(mainBanner[5]?.link);
                      });
                    }}
                  >
                    <img
              ...
              <div className="sm:w-1/4 md:w-1/4 w-1/2 p-2">
                <div className="rounded-lg relative overflow-hidden">
                  <Link
                    href={mainBanner[6]?.link || "#"}
                    onClick={(ev) => {
                      ev.preventDefault();
                      startTransition(() => {
                        router.push(mainBanner[6]?.link);
                      });
                    }}
                  >
                    <img
