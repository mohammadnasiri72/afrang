    ...
    <>
      <div className="sm:hidden flex justify-around px-2 fixed bottom-0 bg-white left-0 right-0 py-[12px] text-[#666] z-50">
        ...
        <Link href="/profile/dashboard">
          ...
          <span className="text-3xl cursor-pointer inline-block align-middle" style={{ width: '1em', height: '1em' }}>
            ...
            >
              ...
              <path d="M8 25c0-3.3137 3.582-6 8-6s8 2.6863 8 6" stroke="#d1182b" strokeWidth="2"/>
            </svg>
          </span>
        </Link>
        ...
        >
          ...
          >
            <rect width="32" height="32" rx="16" fill="#d1182b" fillOpacity="0.08"/>
            <rect x="8" y="10" width="16" height="2.5" rx="1.25" fill="#d1182b"/>
            <rect x="8" y="15" width="16" height="2.5" rx="1.25" fill="#d1182b"/>
            <rect x="8" y="20" width="16" height="2.5" rx="1.25" fill="#d1182b"/>
          </svg>
        </span>
      </div>
    </>
