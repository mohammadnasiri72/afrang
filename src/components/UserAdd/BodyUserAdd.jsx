        ...
        <div className="flex flex-wrap items-center ">
          <div className="p-3 sm:w-1/2 lg:w-1/4 w-full relative">
            <div
              ...
              className={` cursor-pointer text-white rounded-lg  p-3 flex flex-col items-center justify-start gap-2 relative z-50 duration-300 ${activeTab === 1 ? "bg-amber-500" : "bg-amber-400"
                }`}
            >
          ...
          <div className="p-3 sm:w-1/2 lg:w-1/4 w-full relative">
            <div
              ...
              className={` cursor-pointer text-white rounded-lg p-3 flex flex-col items-center justify-start gap-2 relative z-50 ${activeTab === 2 ? "bg-teal-500" : "bg-teal-400"
                }`}
            >
              {/* <img className="w-20" src="/images/gallery/image11.jpg" alt="" /> */}
