...
function AddLegal({
  ...
  const validateForm = () => {
    ...
    if (formData.organizationName.length < 3)
      newErrors.organizationNameLength = "نام شرکت باید بیشتر از 3 حرف باشد";
    if (formData.economicCode.length !== 12)
      newErrors.economicCodeLength = "کد اقتصادی شرکت درست نیست";
    if (formData.nationalId.length !== 11)
      newErrors.nationalIdLength = "شناسه ملی شرکت درست نیست";
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div
              className={`bg-[#fff] rounded-lg px-4 py-2 flex items-center border ${
                errors.organizationName || errors.organizationNameLength
                  ? "border-red-500"
                  : "border-gray-300"
              } focus-within:ring-2 focus-within:ring-[#d1182b] focus-within:border-transparent`}
            >
          ...
          <div>
            ...
            {errors.economicCode && (
              <p className="text-red-500 text-xs mt-1">{errors.economicCode}</p>
            )}
            {!errors.economicCode && errors.economicCodeLength && (
              <p className="text-red-500 text-xs mt-1">
                {errors.economicCodeLength}
              </p>
            )}
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            {errors.selectedCity && (
              <p className="text-red-500 text-xs mt-1">{errors.selectedCity}</p>
            )}
          </div>
