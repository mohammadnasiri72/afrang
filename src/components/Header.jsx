...
const HeaderSkeleton = () => {
  return (
    <div className="flex items-center justify-between lg:px-8 px-2 py-2 bg-white"> {/* کاهش padding */}
      {/* Left Section - Logo and Search */}
      <div className="flex items-center lg:w-1/2 w-auto">
        <div className="flex items-center lg:w-2/5 w-auto">
          {/* Logo */}
          <div className="w-10 h-10 bg-gray-200 animate-pulse rounded-lg" /> {/* کوچکتر */}
          {/* Logo Text */}
          <div className="flex-col px-1 lg:flex hidden">
            <div className="h-4 bg-gray-200 animate-pulse rounded w-20" /> {/* کوچکتر */}
          </div>
        </div>
        {/* Search Bar */}
        <div className="px-2 lg:flex hidden items-center justify-start rounded-lg bg-slate-200 lg:w-3/5 w-4/5">
          <div className="w-5 h-5 bg-gray-300 animate-pulse rounded-full mx-1" /> {/* کوچکتر */}
          <div className="h-6 bg-gray-300 animate-pulse rounded w-full" /> {/* کوچکتر */}
        </div>
      </div>

      {/* Right Section - Contact, User, Cart */}
      <div className="flex items-center justify-end lg:w-1/2 w-auto gap-4"> {/* کاهش فاصله */}
        {/* Contact Info */}
        <div className="lg:flex hidden items-center">
          <div className="bg-slate-200 rounded-lg p-1"> {/* کوچکتر */}
            <div className="w-4 h-4 bg-gray-300 animate-pulse rounded-full" />
          </div>
          <div className="flex flex-col pr-1 gap-1"> {/* کاهش فاصله */}
        ...
        {/* User Section */}
        <div className="flex items-center gap-2"> {/* کاهش فاصله */}
        ...
        {/* Cart Icon */}
        <div className="relative mt-1"> {/* کاهش فاصله */}
