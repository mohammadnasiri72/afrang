...
const SliderHomeSkeleton = dynamic(() =>
  import("@/components/home/SliderHomeSkeleton")
);
...
const SliderProductSecSkeleton = dynamic(() =>
  import("@/components/home/SliderProductSecSkeleton")
);
...
export default async function Home() {
  ...
  try {
    mainBanner = await getListItemBanner();
  } catch (error) {
    console.error("Error fetching slider items:", error);
  }
  ...
  return (
    <div className="bg-[#f6f6f6] overflow-hidden">
      ...
      {mainBanner.filter((e) => e.categoryKey === 'banner_main').length > 0 && (
